...
* [TEDAS Churn Rate](https://mattermost.looker.com/looks/142):
  * The rate (percentage) at which Telemetry-Enabled Servers leave the platform (churn) or disabled telemetry within a given timeframe (number of days) since their first telemetry date. 
